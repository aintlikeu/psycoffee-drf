# serializers
SPOT_DOES_NOT_EXIST = "Окно с таким spot_id не существует"
SPOT_ALREADY_EXIST = "Такое окно уже существует"
SPOT_ALREADY_BOOKED = "Окно уже забронировано"
INCORRECT_SPOT_TIME = "Неверная продолжительность сессии"
INCORRECT_SPOT_DURATION = "Возможные интервалы сессии 60, 90, 120 минут"
